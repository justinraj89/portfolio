...
function page() {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      emailjs.send("service_9r8hrqk", "template_f7p9fat", values, "eW8kyK6tHR-aUkVb_")
      showToast('SUCCESS', '🌎 Message sent!')
    } catch (err) {
      showToast('ERROR', 'Sorry, there is a problem with your e-mail :(')
    }      
    setValues({
      name: "",
      email: "",
  ...
  //   e.preventDefault();
  //   emailjs
  //     .send("service_9r8hrqk", "template_f7p9fat", values, "eW8kyK6tHR-aUkVb_")
  //     .then(
  //       (response) => {
  //         showToast('SUCCESS', 'Message sent!')
  //       },
