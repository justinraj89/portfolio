...
export default function Home() {
  return (
    <>
      <div className="px-4 lg:px-0 lg:grid lg:grid-cols-2 mt-6 lg:mt-0">
        <div className="lg:mt-36 w-fit lg:col-span-1 flex flex-col">
          <motion.div
      ...
      <div className="h-screen border-2 mt-8">
